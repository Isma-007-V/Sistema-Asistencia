...
?>
    <a href="registro_usuario.php" class="btn btn-primary btn-rounded mb-2 "><i class="fa-solid fa-plus"></i>
        &nbsp;Registrar</a>
    ...
    while ($datos=$sql->fetch_object()){?>
            <tr>
                ...
                <td>
                    ...
                    <a href="usuarios.php?id=<?=$datos->id_usuario?>" onclick="advertencia(event)"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="POST">
                                ...
                                <div class="fl-flex-label mb-4 px-2 col-12 ">
                                    <input type="text" placeholder=" usuario" class=" input input__text"
