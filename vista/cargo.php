    ...
    while ($datos=$sql->fetch_object()){?>
            <tr>
                ...
                <td>
                    ...
                    <a href="cargo.php?id=<?=$datos->id_cargo?>" onclick="advertencia(event)"
            ...
            <!-- Modal -->
            <div class="modal fade" id="exampleModal<?= $datos->id_cargo?>" tabindex="-1"
                            ...
                            <form action="" method="POST">
                                <div hidden class="fl-flex-label mb-4 px-2 col-12">
                                    <input type="text" placeholder="id" class=" input input__text"
                                        name="txtid" value="<?= $datos->id_cargo?>">
                                </div>
