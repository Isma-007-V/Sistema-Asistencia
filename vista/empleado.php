...
?>
    <a href="registro_empleado.php" class="btn btn-primary btn-rounded mb-2 "><i class="fa-solid fa-plus"></i>
        &nbsp;Registrar</a>
    ...
    while ($datos=$sql->fetch_object()){?>
            <tr>
                ...
                <td>
                    ...
                    <a href="empleado.php?id=<?=$datos->id_empleado?>" onclick="advertencia(event)"
                            ...
                            <form action="" method="POST">
                                <div hidden class="fl-flex-label mb-4 px-2 col-12">
                                    <input type="text" placeholder="id" class=" input input__text"
                                        name="txtid" value="<?= $datos->id_empleado?>">
                                </div>
